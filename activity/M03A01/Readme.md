...
|:----------------------------------------------------------------------------------------------------|:-----------------------------------------|
| [:notebook:Lectura](https://www.autodesk.com/mx/solutions/bim/benefits-of-bim)                        | ¿Cuáles son las ventajas de BIM?         |  
| [:notebook:Lectura](https://betterpros.com/careers/es/blog/diferencias-entre-bim-y-mep/)         | ¿Cuál es la diferencia entre BIM y MEP?                    |        
...
|    Nivel    | Alcance                                                                     | Datos gráficos                                                                                                                                                                                      | Datos no gráficos                                                                                                                                                                          |
|:-----------:|-----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **LOD100**  | Modelo con información general                                              | • Existencia de elementos (representación simbólica).<br/>• Ubicación aproximada.                                                                                                                   |                                                                                                                                                                                            |
| **LOD200**  | Modelo con información básica aproximada                                    | • Existencia de elementos.<br/>• Cantidades, espesor y dimensiones aproximadas.                                                                                                                     | • Distinción informativa de categorías.<br/>• Datos conocidos no determinantes de referencias de elementos constructivos.                                                                  |
| **LOD300**  | Modelo con información detallada                                            | • Cantidades, espesores y dimensiones específicas.<br/>• Materiales.<br/>• Representación de la composición de elementos.                                                                             | • Marcas, modelos y materiales.<br/>• Datos físicos y/o técnicos determinantes de elementos constructivos.                                                                                 |
| **LOD400**  | Modelo con información detallada y coordinada                               | • Cantidades, espesores y dimensiones específicas.<br/>• Materiales.<br/>• Representación de la composición e intersección de elementos y soportes.<br/>• Fabricación, ensamblaje e instalación.      | • Marcas, modelos y materiales.<br/>• Datos físicos y/o técnicos determinantes de elementos constructivos.<br/>• Fichas técnicas.<br/>• Manuales de instalación.                           |
| **LOD500**  | Modelo con información detallada de la fabricación o construcción y montaje | • Cantidades, espesores y dimensiones específicas.<br/>• Materiales.<br/>• Representación de la composición e intersección de elementos y soportes.<br/>• Información gráfica conforme a lo ejecutado. | • Marcas y modelos.<br/>• Datos físicos y/o técnicos determinantes de elementos constructivos.<br/>• Datos para mantenimiento: guías, fichas técnicas, información comercial y revisiones. |
...
| [◄ Anterior](../M02A04/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.DAPC/discussions/1) | [Siguiente ►](../M03A02/Readme.md) |
|---------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|----------------------------------------------------|
