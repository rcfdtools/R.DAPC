...
|:------------------------------------------------------------------------------------------:|:----------------------|:------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                                            | Coordinates           | <kbd>ctrl</kbd> + <kbd>i</kbd> | Activa la visualización de posición del cursor en el espacio de trabajo.<br><img src="graph/AutoCAD_ToolCoordinates.jpg" alt="R.DAPC" width="130" border="0" /> |
|                                                                                            | Model Space           |         <kbd>F7</kbd>          | <img src="graph/AutoCAD_ToolModelSpace.jpg" alt="R.DAPC" width="35" border="0" />                                                                               |
