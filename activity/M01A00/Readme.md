...
|:--------------------------------------------------------------------------------------------------:|:----------------------|:--------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                                                    | Coordinates           |   <kbd>ctrl</kbd>+<kbd>i</kbd> <br>COORDS    | Activa la visualización de posición del cursor en el espacio de trabajo. <img src="graph/AutoCAD_ToolCoordinates.jpg" alt="R.DAPC" height="28" border="0" /> |
|                                                                                                    | Model Space           |                                              | <img src="graph/AutoCAD_ToolModelSpace.jpg" alt="R.DAPC" height="28" border="0" />                                                                           |
|            <img src="graph/AutoCAD_ToolGrid.jpg" alt="R.DAPC" height="28" border="0" />            | Grid                  |     <kbd>F7</kbd> <br>GRID <br>GRIDMODE      |                                                                                                                                                              |
...
|     <img src="graph/AutoCAD_ToolAnnotationMonitor.jpg" alt="R.DAPC" height="28" border="0" />      | Annotation Monitor    |                 ANNOMONITOR                  |                                                                                                                                                              |
...
|     <img src="graph/AutoCAD_ToolAnnotationMonitor.jpg" alt="R.DAPC" height="28" border="0" />      | Annotation Monitor    |                                              |                                                                                                                                                              |
