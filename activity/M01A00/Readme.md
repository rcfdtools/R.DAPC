...
|:------------------------------------------------------------------------------------------:|:----------------------|:------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                                            | Coordinates           | <kbd>ctrl</kbd> + <kbd>i</kbd> | Activa la visualización de posición del cursor en el espacio de trabajo.<br><img src="graph/AutoCAD_ToolCoordinates.jpg" alt="R.DAPC" height="25" border="0" /> |
...
|  <img src="graph/AutoCAD_ToolInferConstraints.jpg" alt="R.DAPC" height="25" border="0" />   | Gizmo                 |                                |                                                                                                                                                                 |
|        <img src="graph/AutoCAD_ToolGizmo.jpg" alt="R.DAPC" height="25" border="0" />        | Annotation Visibility |                                |                                                                                                                                                                 |
...
|    <img src="graph/AutoCAD_ToolClean Screen.jpg" alt="R.DAPC" height="25" border="0" />     | Clean Screen          |                                |                                                                                                                                                                 |
