...
|:--------------------------------------------------------------------------------------------:|:----------------------|:----------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                                              | Coordinates           | <kbd>ctrl</kbd>+<kbd>i</kbd> | Activa la visualización de posición del cursor en el espacio de trabajo. <img src="graph/AutoCAD_ToolCoordinates.jpg" alt="R.DAPC" height="25" border="0" /> |
|                                                                                              | Model Space           |        <kbd>F7</kbd>         | <img src="graph/AutoCAD_ToolModelSpace.jpg" alt="R.DAPC" height="25" border="0" />                                                                           |
|         <img src="graph/AutoCAD_ToolGrid.jpg" alt="R.DAPC" height="25" border="0" />         | Grid                  |                              |                                                                                                                                                              |
|       <img src="graph/AutoCAD_ToolSnapMode.jpg" alt="R.DAPC" height="25" border="0" />       | Snap Mode             |                              |                                                                                                                                                              |
