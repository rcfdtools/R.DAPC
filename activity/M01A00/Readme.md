...
|-------------------------------------------------------------------------------------|-----------------------|-------------------------------|--------------------------------------------------------------------------|
| <img src="graph/AutoCAD_ToolCoordinates.jpg" alt="R.DAPC" width="120" border="0" /> | Coordinates           | <kbd>esc</kbd> + <kbd>i</kbd> | Activa la visualización de posición del cursor en el espacio de trabajo. |
|                                                                                     | Model Space           |                               |                                                                          |
|                                                                                     | Grid                  |                               |                                                                          |
|                                                                                     | Snap Mode             |                               |                                                                          |
|                                                                                     | Infer Constraints     |                               |                                                                          |
