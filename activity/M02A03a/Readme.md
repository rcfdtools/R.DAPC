...
| M02A03a   | Desarrolle los numerales indicados en esta actividad y presente un informe técnico detallado con capturas de pantalla de todas las herramientas utilizadas. Incluir en la carpeta /shp, las capas creadas. Para el predio del campus de la [UECIJG](https://www.escuelaing.edu.co), determine el % de afectación.                                                                                                                                                                                                                                    |
