...
| M01A01a   | En el archivo _M01A01a.dwg_, cree las capas establecidas en el catálogo [DAPC_AIALayerName.xlsx](../../file/table/DAPC_AIALayerName.xlsx) para el curso DACP. En las descripciones incluya el nombre de la disciplina un guión y la descripción, p. ej., _Arquitectura - Área_.                                                                                                                                                                                                                                                                      |
