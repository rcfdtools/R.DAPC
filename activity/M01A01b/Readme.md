...
|:------------------------------------------------------------------------------------------------:|:-------------------------|:--------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      <img src="../../file/graph/AutoCAD_ToolMOVE.jpg" alt="R.DAPC" width="28" border="0" />      | Move                     | <kbd>M</kbd> MOVE         | Mover elementos del dibujo.                                                                                                                                                                             |
|     <img src="../../file/graph/AutoCAD_ToolROTATE.jpg" alt="R.DAPC" width="28" border="0" />     | Rotate                   | <kbd>RO</kbd> ROTATE      | Rotar elementos del dibujo.                                                                                                                                                                             |
|      <img src="../../file/graph/AutoCAD_ToolTRIM.jpg" alt="R.DAPC" width="28" border="0" />      | Trim                     | <kbd>TR</kbd> TRIM        | Recortar elementos a partir de otros elementos.                                                                                                                                                         |
|     <img src="../../file/graph/AutoCAD_ToolEXTEND.jpg" alt="R.DAPC" width="28" border="0" />     | Extend                   | <kbd>EX</kbd> EXTEND      | Extender elementos. Esta herramienta se encuentra en el expansor de Trim.                                                                                                                               |
|     <img src="../../file/graph/AutoCAD_ToolERASE.jpg" alt="R.DAPC" width="28" border="0" />      | Erase  / Delete          | <kbd>E</kbd> ERASE        | Remueve o elimina elementos del dibujo.                                                                                                                                                                 |
|      <img src="../../file/graph/AutoCAD_ToolCOPY.jpg" alt="R.DAPC" width="28" border="0" />      | Copy                     | <kbd>CP</kbd> COPY        | Copia elementos a una distancia o dirección específica.                                                                                                                                                 |
|     <img src="../../file/graph/AutoCAD_ToolMIRROR.jpg" alt="R.DAPC" width="28" border="0" />     | Mirror                   | <kbd>MI</kbd> MIRROR      | Crea una copia espejo de un elemento seleccionado.                                                                                                                                                      |
|     <img src="../../file/graph/AutoCAD_ToolFILLET.jpg" alt="R.DAPC" width="28" border="0" />     | Fillet                   | <kbd>F</kbd> FILLET       | Redondea o filetea las aristas de objetos, p. ej., la esquina de una manzana urbana.                                                                                                                    |
|    <img src="../../file/graph/AutoCAD_ToolCHAMFER.jpg" alt="R.DAPC" width="28" border="0" />     | Chamfer                  | <kbd>CHA</kbd> CHAMFER    | Bisela las aristas de objetos.                                                                                                                                                                          |
|     <img src="../../file/graph/AutoCAD_ToolBLEND.jpg" alt="R.DAPC" width="28" border="0" />      | Blend curves             | BLEND                     | Crea una tangente o una línea suaviza espiral entre los puntos finales de dos curvas abiertas.                                                                                                          |
|    <img src="../../file/graph/AutoCAD_ToolEXPLODE.jpg" alt="R.DAPC" width="28" border="0" />     | Explode                  | EXPLODE / BREAKUP         | Separa un objeto compuesto en la partes que lo componen, p. ej., al explotar un rectángulo se obtienen sus 4 lados.                                                                                     |
|    <img src="../../file/graph/AutoCAD_ToolSTRETCH.jpg" alt="R.DAPC" width="28" border="0" />     | Stretch                  | STRETCH                   | Extiende objetos a partir de una selección de caja o polígono.                                                                                                                                          |
...
|     <img src="../../file/graph/AutoCAD_ToolALIGN.jpg" alt="R.DAPC" width="28" border="0" />      | Align                    | <kbd>AL</kbd> ALIGN       | Alinear un objeto con otro.                                                                                                                                                                             |
...
Creando un array de 10 líneas horizontales y 10 líneas verticales y trazando líneas, cree el logo de la UECIJG. El ancho y alto de la figura debe corresponder a los 3 últimos dígitos de su código de estudiante. Guarde el dibujo como _/file/cad/**M01A01bE09**.dwg_.

<div align="center"><img src="graph/M01A01bE09.jpg" alt="R.DAPC" width="100%" border="0" /><br><sub>Tomado de: Dibujo Técnico I - DGEP (pág. 123)</sub></div>
