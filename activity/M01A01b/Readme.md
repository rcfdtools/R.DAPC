...
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Rotate                   | <kbd>RO</kbd> ROTATE      | Rotar elementos del dibujo.                                                                                                                                                                             |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Trim                     | <kbd>TR</kbd> TRIM        | Recortar elementos a partir de otros elementos.                                                                                                                                                         |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Extend                   | <kbd>EX</kbd> EXTEND      | Extender elementos. Esta herramienta se encuentra en el expansor de Trim.                                                                                                                               |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Erase  / Delete          | <kbd>E</kbd> ERASE        | Remueve o elimina elementos del dibujo.                                                                                                                                                                 |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Copy                     | <kbd>CP</kbd> COPY        | Copia elementos a una distancia o dirección específica.                                                                                                                                                 |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Mirror                   | <kbd>MI</kbd> MIRROR      | Crea una copia espejo de un elemento seleccionado.                                                                                                                                                      |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Fillet                   | <kbd>F</kbd> FILLET       | Redondea o filetea las aristas de objetos, p. ej., la esquina de una manzana urbana.                                                                                                                    |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Chamfer                  | <kbd>CHA</kbd> CHAMFER    | Bisela las aristas de objetos.                                                                                                                                                                          |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Blend curves             | BLEND                     | Crea una tangente o una línea suaviza espiral entre los puntos finales de dos curvas abiertas.                                                                                                          |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Explode                  | EXPLODE / BREAKUP         | Separa un objeto compuesto en la partes que lo componen, p. ej., al explotar un rectángulo se obtienen sus 4 lados.                                                                                     |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Stretch                  | STRETCH                   | Extiende objetos a partir de una selección de caja o polígono.                                                                                                                                          |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Scale                    | <kbd>SC</kbd> SCALE       | Escala un objeto, valores superiores a 1 agrandan el objeto en proporción al valor ingresado, valores menores a 1 reducen el objeto.                                                                    |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Rectangular Array        | ARRAYRECT                 | Crea un arreglo de objetos o copia múltiple de objetos en una secuencia rectangular.                                                                                                                    |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Path Array               | ARRAYPATH                 | Crea un arreglo de objetos o copia múltiple de objetos a lo largo de una trayectoria definida.                                                                                                          |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Polar Array              | ARRAYPOLAR                | Crea un arreglo de objetos o copia múltiple de objetos al rededor de una circunferencia.                                                                                                                |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Offset                   | <kbd>O</kbd> OFFSET       | Crea lineas paralelas a un objeto, distancias positivas indican que la paralela se traza fuera del objeto cuando este es una polilínea cerrada.                                                         |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Set To ByLayer           | SETBYLAYER                | Permite restablecer la propiedades de capa de un objeto.                                                                                                                                                |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Change Space             | CHSPACE                   | Permite transferir un objeto entre el espacio de modelado o el espacio de dibujo de impresión.                                                                                                          |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Lengthen                 | LENGTHEN                  | Alargar un objeto estableciendo un valor o porcentaje.                                                                                                                                                  |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Edit Polyline            | <kbd>PE</kbd> PEDIT       | Editar una polilínea, p. ej., para cerrarla.                                                                                                                                                            |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Edit Spline              | SPLINEDIT                 | Editar líneas espirales.                                                                                                                                                                                |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Edit Hatch               | HATCHEDIT                 | Editar achurados o rellenos.                                                                                                                                                                            |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Edit Array               | ARRAYEDIT                 | Editar arreglos de objetos.                                                                                                                                                                             |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Align                    | <kbd>AL</kbd> ALIGN       | Alinear un objeto con otro.                                                                                                                                                                             |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Break                    | BREAK                     | Partir un objeto entre dos puntos.                                                                                                                                                                      |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Break at Point           | <kbd>M</kbd> BREAKATPOINT | Partir un objeto en un punto especificado.                                                                                                                                                              |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Join                     | <kbd>J</kbd> JOIN         | Unir objetos para crear un único objeto.                                                                                                                                                                |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Reverse                  | REVERSE                   | Cambiar el sentido vectorial de dibujo de un objeto, p. ej., al digitalizar un río, este puede haber sido digitalizado en el sentido inverso del flujo y con este comando podrá cambiar su sentido.     |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Copy Nested Objects      | NCOPY                     | Copia objetos embebidos dentro de bloques o archivos de dibujo de referencias externas.                                                                                                                 |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Delete Duplicate Objects | OVERKILL                  | Elimina elementos duplicados idénticos.                                                                                                                                                                 |
| <img src="../../file/graph/AutoCAD_ToolMove.jpg" alt="R.DAPC" height="28" border="0" /> | Bring To                 | DRAWORDER                 | Cambia el orden o posición de dibujo de un objeto con respecto a otro, p. ej., una columna que se encuentra en la capa S-COLS puede ser colocada encima o debajo de un muro dibujado en la capa A-WALL. |
