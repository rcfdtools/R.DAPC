...
| M02A03b   | En grupo: desarrolle los numerales indicados en esta actividad y presente un informe técnico detallado con capturas de pantalla de todas las herramientas utilizadas. Incluir en la carpeta /shp, las capas creadas.                                                                                                                                                                                                                                                                                                                                             |
| M02A03b   | En grupo: investigue que es la catenaria en un vano eléctrico y calcule la longitud real del cableado teniendo en cuenta la curvatura de la catenaria entre torres.                                                                                                                                                                                                                                                                                                                                                                                              |
| M02A03b   | En grupo: realice el procedimiento de estimación de longitud 3D de las líneas de transmisión utilizando 3 diferentes modelos de elevación digital DEM, p. ej., Copernicus 30m, ASTER GDEM v3 y SRTM.                                                                                                                                                                                                                                                                                                                                                             |
...
| [◄ Anterior](../M02A03a/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.DAPC/discussions/1) | [Siguiente ►](../M02A03c/Readme.md) |
|---------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|---------------------------------------------------|
