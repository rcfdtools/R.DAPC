...
| Placa de contra piso          |           | 40 centímetros de espesor en concreto reforzado. Investigar especificaciones de refuerzo y dibujar detalle estructural. <br><br>:fire:Atención: tenga en cuenta que este tipo de elementos requieren de un diseño avanzado; los valores aquí definidos son esquemáticos y requieren ser revisados por un ingeniero experto.                                                                                                                                   |
| Estructura                    |           | Libre elección: metálica o en concreto utilizando pórticos con 6 metros de luz o espaciado entre apoyos. Para dibujo en planta y cortes utilizar elementos de 30 x 50 centímetros. Investigar especificaciones de refuerzo y dibujar detalle estructural. <br><br>:fire:Atención: tenga en cuenta que este tipo de elementos requieren de un diseño avanzado; los valores aquí definidos son esquemáticos y requieren ser revisados por un ingeniero experto. |
|                               |           |                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
