...
|:---------------------------|:----------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Código, nombre y logotipo  |           | El proyecto se desarrolla en grupo, el número de estudiantes se indica en clase. Cada grupo tendrá un código numérico consecutivo asignado por el instructor. Los estudiantes deberán definir el nombre de su grupo de proyecto y crear un logotipo en AutoCAD. El código, logotipo y nombre del grupo deberá incluirse en todos los planos generados.                                                                                            |
...
| Especificación                | Actividad | Descripción y alcance                                                       |
|:------------------------------|:----------|:----------------------------------------------------------------------------|
| Plano de planta general       |           | Planta con visibilidad interna de la distribución de los espacios internos. |
| Plano de cubiertas y fachadas |           |                                                                             |
