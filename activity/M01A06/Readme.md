...
| Redes                      | Redes eléctricas para 110V y 220V, red de datos usando cableado, red de iluminación, red fotovoltáica, red de vigilancia. Indicar la localización de tomacorrientes, interruptores, luminarias, luces de emergencia. Esquemas solo en planta.     |           |
