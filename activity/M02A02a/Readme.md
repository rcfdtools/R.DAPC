...
|:---------|:-------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PredioID | String (200) | Consultar el catastro distrital o nacional y obtener el código CHIP o llave predial de este predio.<br/>:pencil2: Es necesario investigar y documentar el proceso de obtención del código predial. |
...
| RadioC   | Real (10)    | Radio de iluminación directa o de cobertura en función de la potencia, altura y tipo.<br/>:pencil2: Investigar y estimar.<br><br>Por ejemplo:<br>Lámparas de menos de 6 metros de altura: 10 metros.<br>Lámparas de más de 6 metros: entre 10 y 25 metros. |
