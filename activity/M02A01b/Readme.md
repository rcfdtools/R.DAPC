...
| M02A01a    | Identifique en UPZ se encuentra el campus de la [UECIJG](https://www.escuelaing.edu.co) y presente un análisis de luminarias identificando desde Google Maps y Google StreetView, cuantos postes de la red pública se encuentran al rededor del predio del campus.                                                                                                                                                                                                                                                                                                                    |
