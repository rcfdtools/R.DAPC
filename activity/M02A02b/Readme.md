...
| B     | Long Integer | Número de páneles: `B = Entero(AreaUsable / ((AnchoPanelenmilimetros * AltoPanelenmilimetros) / (1000 * 1000)))`. Tamaño de cada panel: 1950 x 992 milímetros. QGIS: `floor("A"/((1950*992)/(1000*1000)))`. :pencil2: Investigar y justificar el tamaño de cada panel. |
| C     | Real (10)    | Potencial de Kilovatios producidos por hora (Kwh): `C = B * Potencia Panel / 1000`. Potencia por panel: 330 watts-hora. :pencil2: Investigar y justificar la potencia por panel.                                                                                       |
| D     | Real (10)    | Real de Kilovatios producidos por hora (Kwh): `D = C / Factor Pérdida`.  Factor de Perdida: 1.43. :pencil2: Investigar y justificar el factor de pérdida.                                                                                                              |
...
| F     | Real (10)    | Potencial de Kilovatios producidos por dia para las horas de sol efectivas (Kwh - dia): `F = C * HorasEfectivasSolDia`.  Horas efectivas de sol al día: 5 hr/día. :pencil2: Investigar y justificar el número de horas efectivas de sol en Bogotá D.C.                 |
...
| M02A02b   | En grupo: desarrolle los numerales indicados en esta actividad y presente un informe técnico detallado con capturas de pantalla de todas las herramientas utilizadas. Incluir en la carpeta /shp, las capas creadas. :pencil2: Investigar especificaciones técnicas y costos de instalación por KW solar instalado.                                                                                                                                                                                                                                            |
...
| [◄ Anterior](../M02A02a/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.DAPC/discussions/1) | [Siguiente ►](../M02A03a/Readme.md) |
|----------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|----------------------------------------------------|
