...
| M02A02b   | Opcional en grupo: desarrolle los numerales indicados en esta actividad y presente un informe técnico detallado con capturas de pantalla de todas las herramientas utilizadas. Incluir en la carpeta /shp, las capas creadas. Investigar especificaciones técnicas y costos de instalación por KW solar instalado.                                                                                                                                                                                                                                                      |
