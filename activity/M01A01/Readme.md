...
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------|:-----------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                                                                                                                                                   | Coordinates           | <kbd>ctrl</kbd>+<kbd>i</kbd> <br>COORDS              | Activa la visualización de posición de coordenadas del cursor en el espacio de trabajo. <img src="../../file/graph/AutoCAD_Coordinates.png" alt="R.DAPC" width="130" border="0" />                                                                                                                                  |
