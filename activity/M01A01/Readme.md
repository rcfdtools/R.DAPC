...
| <img src="../../file/graph/AutoCAD_ToolDynamicUCS.jpg" alt="R.DAPC" width="28" border="0" />                                                                                                               | Dynamic UCS           | <kbd>F6</kbd> <br>UCSDETECT                          | Activa el modo de visualización dinámica del sistema de coordenadas de usuario (UCS) del dibujo, que temporalmente alinea el plano XY del UCS a la cara planar de un sólido 3D.                                                         |
