...
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------|:-----------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                                                                                                                                                           | Coordinates           | <kbd>ctrl</kbd>+<kbd>i</kbd> <br>COORDS              | Activa la visualización de posición de coordenadas del cursor en el espacio de trabajo. <img src="../../file/graph/AutoCAD_ToolCoordinates.jpg" alt="R.DAPC" width="120" border="0" />                                                  |
|                                                                                                                                                                                                           | Model Space           |                                                      | Cambiar de espacio de modelo a espacio de papel. <img src="../../file/graph/AutoCAD_ToolModelSpace.jpg" alt="R.DAPC" width="60" border="0" />                                                                                           |
