...
| <img src="../../file/graph/AutoCAD_SnapMode.png" alt="R.DAPC" width="28" border="0" />                                                                                                            | Snap Mode             | <kbd>F9</kbd> <br>SNAP <br>SNAPMODE                  | Activa el ajuste de encajado (polar o grid) a la grilla de referencia. El espaciamiento de encajado puede ser definido por el usuario y ser diferente al espaciamiento definido en la grilla de referencia.                                                                                                         |
