...
| [:date:DAPC_VolumenArea MasaSolido.xlsx](../../file/table/DAPC_VolumenAreaMasaSolido.xlsx)                              | Libro de cálculo para la estimación de área superficial, volúmen y masa de objetos nativos 3D.             |
| [:date:DAPC_ElectricElbow BellEnd.xlsx](../../file/table/DAPC_ElectricElbowBellEnd.xlsx)                                | Libro de cálculo con especificaciones técnicas geométricas de codos para conductos eléctricos marca LEDES. |
...
## 2. Solid Editing / Extrude (extrusión) <img src="../../file/graph/AutoCAD_ModelingExtrude.png" alt="R.DAPC" height=25 border="0" />
...
A partir de la figura dibujada en el ejercicio [M01A01E06](../M01A01), cree un sólido y calcule su área superficial, volumen y masa.
...
A partir de la figura dibujada en el ejercicio [M01A01E05](../M01A01), cree un sólido y calcule su área superficial, volumen y masa.
...
A partir de la figura dibujada en el ejercicio [M01A02bE04](../M01A02), cree un sólido y calcule su área superficial, volumen y masa.
...
A partir de la figura dibujada en el ejercicio [M01A02bE06](../M01A02), cree un sólido y calcule su área superficial, volumen y masa.
...
## 3. Solid Editing / Revolve (revolución) <img src="../../file/graph/AutoCAD_ModelingRevolve.png" alt="R.DAPC" height=25 border="0" />
