...
Para la construcción de esta figura, cree primero el cubo y las circunferencias en 3 caras ortogonales, luego realice extrusiones de las circunferencias externas iguales al ancho del cubo y hacia adentro, realice su unión, luego con **PRESPULL** o con **SUBSTRACT** recorte el volumen interno a partir de las circunferencias interiores; por último, realice el suavizado de las aristas.
...
| Actividad | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|:----------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| M01A02d   | Individual: los numerales vistos en esta actividad son evaluados individualmente a través de un quiz de conocimiento y habilidad.                                                                                                                                                                                                                                                                                                                                                                                                                              |
| M01A02d   | En grupo: dibuje los elementos de proyecto del grupo _3. Especificaciones eléctricas / 3a. Especificaciones generales y redes_, correspondientes a: pararrayos en 3D. Investigue qué es y para que sirve un pararrayos, dibujo y presente los elementos directrices para la generación del elemento 3D. [Buscar ejemplos](https://www.bibliocad.com/search/?term=pararrayos).                                                                                                                                                                                  |
...
| [◄ Anterior](../M01A02c/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.DAPC/discussions/1) | [Siguiente ►](../M01A03/Readme.md) |
|---------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------|
