...
| [2.2.a. Definición y edición de elementos / Digitalización](activity/M02A02a/Readme.md)                         | Bases de datos y su manejo en SIG. Definición de elementos de un SIG (shapes, raster, vectores, etc.). Edición de elementos. Digitalización y entrada de entidades. |        3.0        |
| [2.2.b. Definición y edición de elementos / Potencial fotovoltáico](activity/M02A02b/Readme.md)                 | Bases de datos y su manejo en SIG. Creación y edición de tablas relacionales. Generación de entidades geográficas.                                                  |        3.0        |
...
| 2.3.c. Mapas e imágenes / Análisis de potencial eólico usando ERA5 Land Monthly                                 | Mapas y cartografía. Elaboración de planos. Imágenes en SIG. Manejo y manipulación de imágenes. Procesamiento de datos de reanálisis ERA5.                          |        3.0        |
