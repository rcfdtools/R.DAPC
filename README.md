...
| [2.2. Definición y edición de elementos](activity/M02A02/Readme.md) | Bases de datos y su manejo en SIG. Definición de elementos de un SIG (shapes, raster, vectores, etc.). Edición de elementos. Digitalización y entrada de entidades. Creación y edición de tablas relacionales. |        6.0        |
